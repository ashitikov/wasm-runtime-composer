...
pub(crate) type ReplyTx = tokio::sync::oneshot::Sender<Result<(), CompositionError>>;
...
pub(crate) fn into_wasmtime_error(e: CompositionError) -> wasmtime::Error {
    match e {
